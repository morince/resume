...
<!-- //for-mobile-apps -->
<link href="${rc.contextPath}/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="${rc.contextPath}/css/indexstyle.css" rel="stylesheet" type="text/css" media="all" />
<!-- gallery -->
...
<!-- banner -->
	<div class="banner">
			<!--Slider-->
			<img src="images/resumeimages/pic2.jpg" alt=" " class="img-responsive">
					<h2>${resume.name}</h2>
		...
		<div class="w3l-grids-about">
				<div class="col-md-5 w3ls-ab-right">
					<div class="agile-about-right-img">
						<img src="images/resumeimages/ab.jpg" alt="">
					</div>
				</div>
			...
			<p class="w3ls_head_para">See My Works</p>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/1.jpg">
							<img src="images/resumeimages/1.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/2.jpg">
							<img src="images/resumeimages/2.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/3.jpg">
							<img src="images/resumeimages/3.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/4.jpg">
							<img src="images/resumeimages/4.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/5.jpg">
							<img src="images/resumeimages/5.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/6.jpg">
							<img src="images/resumeimages/6.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
				...
				<div class="col-md-4 agileits_portfolio_grid">
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/7.jpg">
							<img src="images/resumeimages/7.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/8.jpg">
							<img src="images/resumeimages/8.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
					...
					<div class="agileinfo_portfolio_grid hovereffect">
						<a class="cm-overlay" href="images/resumeimages/9.jpg">
							<img src="images/resumeimages/9.jpg" alt=" " class="img-responsive">
							<div class="overlay">
								<h4>Classy Resume</h4>
...
<script src="${rc.contextPath}/js/bars.js"></script>

<!-- start-smoth-scrolling -->
<script type="text/javascript" src="${rc.contextPath}/js/move-top.js"></script>
<script type="text/javascript" src="${rc.contextPath}/js/easing.js"></script>
<script type="text/javascript">
